...
export const ACHIEVEMENTS: Record<string, AchievementDef> = {
  ...
  // V8.3: 20 new achievements (awarded via event outcomes)
  angel_backer: { label: 'Angel Backer', icon: '😇' },
  turnaround_artist: { label: 'Turnaround Artist', icon: '🔧' },
  market_timer: { label: 'Market Timer', icon: '⏱️' },
  crisis_manager: { label: 'Crisis Manager', icon: '🧯' },
  green_pioneer: { label: 'Green Pioneer', icon: '🌱' },
  whistle_blower: { label: 'Whistleblower', icon: '📢' },
  viral_sensation: { label: 'Viral Sensation', icon: '🔥' },
  mentor_of_many: { label: 'Mentor of Many', icon: '🧑‍🏫' },
  world_traveler: { label: 'World Traveler', icon: '🧳' },
  art_patron: { label: 'Art Patron', icon: '🖼️' },
  marathoner: { label: 'Marathoner', icon: '🏃' },
  master_negotiator: { label: 'Master Negotiator', icon: '🤝' },
  disaster_survivor: { label: 'Disaster Survivor', icon: '🌪️' },
  community_hero: { label: 'Community Hero', icon: '🦸' },
  tastemaker: { label: 'Tastemaker', icon: '🎨' },
  night_owl_founder: { label: 'Night Owl Founder', icon: '🦉' },
